...
HashTable<Cell>::HashTable(size_t initialSize)
{
    ...
    // Allocate fixed block storage for each of the cells.

    // Initialize zero cell
    m_zeroUsed = 0;
    m_zeroCell.key = 0;
    m_zeroCell.value = nullptr;
}
...
/*
template <typename Cell>
void HashTable<Cell>::Delete(Cell* cell)
{
    if (cell != &m_zeroCell)
    {
...
//----------------------------------------------
template <typename Cell>
void HashTable<Cell>::Repopulate(size_t desiredSize)
{
